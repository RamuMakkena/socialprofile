...
exports.thoughtsRouter.route("/:id/reactions")
    .put(thought_controller_1.thoughtController.addReaction);
exports.thoughtsRouter.route("/:id/reactions/:reactionId")
    .put(thought_controller_1.thoughtController.removeReaction);
